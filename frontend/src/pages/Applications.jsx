...
export default function Applications() {
  ...
  const getStatusColor = (status) => {
    const colors = {
      ...
      manager_approved: 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300',
    ...
    <Layout>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-8 text-center">
          ...
          <Link to="/apply-loan" className="text-blue-600 dark:text-blue-400 hover:underline">
            Apply for a loan
          </Link>
        </div>
      ) : (
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Tenure</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {applications.map((app) => (
                <tr key={app.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <td className="px-6 py-4 dark:text-gray-300">₦{app.requested_amount.toLocaleString()}</td>
                  ...
                  <td className="px-6 py-4 text-right">
                    {canGenerateLetter(app.status) && (
                      <button
                        ...
                        className="flex items-center gap-1 ml-auto text-sm text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/30 px-3 py-1 rounded-lg"
