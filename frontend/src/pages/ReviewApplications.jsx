...
export default function ReviewApplications() {
  ...
  // Apply for Customer modal (loan officers)
  ...
  const openApplyModal = async () => {
    try {
      ...
      // Filter to only assigned customers for loan officers
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            {/* Apply for Customer - Loan Officers only */}
            {isLoanOfficer && (
              <button
                  ...
                  <tr key={app.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex justify-end gap-2">
                        <button onClick={() => { setViewModal(app); setReviewComments('') }} className="p-1 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded" title="View">
                          <Eye size={18} />
                        </button>
                        {/* Offer Letter button */}
                        {canGenerateLetter(app.status) && (
                          <button
                            onClick={() => navigate(`/applications/${app.id}/offer-letter`)}
                        ...
                        {canModify && (
                          <>
                            <button onClick={() => handleEdit(app)} className="p-1 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 rounded" title="Edit">
                              <Edit2 size={18} />
                            </button>
                            <button onClick={() => setDeleteModal(app)} className="p-1 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded" title="Delete">
                              <Trash2 size={18} />
                            </button>
                          </>
                        )}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-lg">
            ...
            <form onSubmit={handleApplyForCustomer} className="space-y-4">
              <div>
                ...
                <select value={applyForm.customer_id} onChange={e => setApplyForm({...applyForm, customer_id: e.target.value})}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              {/* Offer Letter button in modal */}
              {canGenerateLetter(viewModal.status) && (
                <div className="border-t dark:border-gray-700 pt-4">
                  <button
                    onClick={() => navigate(`/applications/${viewModal.id}/offer-letter`)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Are you sure you want to delete application <strong className="dark:text-white">{deleteModal.application_number}</strong>? This action cannot be undone.
            </p>
            <div className="flex gap-3">
